...
module volume_processing
    ...
    subroutine internal_edge_volume_processing
        ...
        do ie = 1, i_nedge
            ...
            do ef=1,face_count
                ...
                if (centroid_index_array(i-1) .eq. cell_1)
    ...
    subroutine centroid_array_routine(obj_projection, obj_centroid, centroid_array_count, centroid_array, i1, i2)
        ...
        do i=2,centroid_array_count
            call cvolume(obj_projection, vol(i1), vol(i2), coords(i1,:), coords(i2,:), obj_centroid, centroid_array_count(i-1), centroid_array_count(i))
        enddo
