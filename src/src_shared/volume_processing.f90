...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine projection_test
        ...
        enddo
        print'(a,4f4.3,i,a,4f4.3,i)', 'lowest sn  ', projection_mag(i1), sn(i1,:), i1, ' highest sn  ', projection_mag(i2), sn(i2,:), i2
        print*, ' '
        ...
        enddo
        print'(a,4f4.3,i,a,4f4.3,i)', 'lowest sb  ', projection_mag(i1), sb(i1,:), i1, ' highest sb  ', projection_mag(i2), sb(i2,:), i2
        print*, ' '
        ...
        enddo
        print'(a,4f4.3,i,a,4f4.3,i)', 'lowest sbb ', projection_mag(i1), sbb(i1,:), i1, ' highest sbb ', projection_mag(i2), sbb(i2,:), i2
        print*, ' '
        ...
        print'(a,f4.3,i,a,f4.3,i)', 'lowest vol ', vol(i1), i1, ' highest vol ', vol(i2), i2
        print*, ' '
