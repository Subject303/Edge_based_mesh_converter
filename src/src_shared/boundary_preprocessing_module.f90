        ...
        do bp=1,b_npoin
            ...
            do i=1,3
                ...
                do f=pf_start,pf_end
                    if (f_bound_array(p_f_obj_relation_array(f))) p_normal_vectors(bp,i) = p_normal_vectors(bp,i) + f_normal_vectors(reversed_f_bound_indexing_array(p_f_obj_relation_array(f)),i)
                enddo
