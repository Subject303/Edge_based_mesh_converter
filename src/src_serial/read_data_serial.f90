...
module read_data_serial
    ...
    subroutine read_data
        ...
        print *, 'mesh contains ', npoin, ' points, ', nedge, ' edges, ' faces, ' faces, ' elements, ' elements'
        ...
        print*, 'total memory size of raw data :: ', ( (real_length*3*npoin) + (4*( 4 + nele + nface + c_p_sum + f_p_sum + (2*nedge) + 2 + nele + nface + c_f_sum + f_e_sum + 4)))  , ' bytes'
        print*, ' '
